...
# Description:
# This script updates ROS package versions in a provided rosdep YAML file.
# - Replaces '=latest' with the latest version from apt-cache.
# - Leaves packages without a version specification unchanged.
#
# Usage:
